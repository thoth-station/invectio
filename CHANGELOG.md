...
* :arrow_up: Automatic update of dependencies by Kebechet for the ubi8 environment
* Add a link to the article published on RH developers
* fixed typo in url
* :arrow_up: Automatic update of dependencies by Kebechet for the ubi8 environment
...
* Release of version 0.1.0 (#92)
* :pushpin: Automatic update of dependency daiquiri from 2.1.1 to 3.0.0 (#91)
...
* :pushpin: Automatic update of dependency pytest from 4.4.1 to 4.6.3
